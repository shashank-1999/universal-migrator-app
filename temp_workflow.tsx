commit 0d33260296feb2b1f4e343054f1278e3cc633b37
Author: Shashank Kumar <shashankbiv@gmail.com>
Date:   Fri Nov 7 09:00:14 2025 +0530

    Initial commit: Universal Migrator app

diff --git a/app/workflow/page.tsx b/app/workflow/page.tsx
new file mode 100644
index 0000000..a503668
--- /dev/null
+++ b/app/workflow/page.tsx
@@ -0,0 +1,883 @@
+"use client";
+
...
+
+/* GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ Types / DB options GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ */
+
...
+
+/* GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ Small UI bits GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ */
+
+function CardShell({
+  title,
+  subtitle,
...
+          </>
+        ) : (
+          <div style={{ color: "#9ca3af" }}>Select a DB on the right GåÆ</div>
+        )}
+      </div>
+    </CardShell>
+
...
+          </>
+        ) : (
+          <div style={{ color: "#9ca3af" }}>Pick destination DB on the right GåÆ</div>
+        )}
+      </div>
+    </CardShell>
+
...
+
+/* GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ Inspector (upload only on Source CSV/Excel) GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ */
+
+function Inspector({
+  selected,
+  setNodes,
...
+        setTestMsg(`G¥î Invalid response (${res.status}): ${text.slice(0, 100)}`);
+        return;
+      }
+
+      if (!res.ok) {
+        console.error("Test failed:", json);
+        setTestMsg("G¥î " + (json.message || `Error ${res.status}`));
+        return;
+      }
+
+      console.log("Test succeeded:", json);
+      setTestMsg("G£à " + (json.message || "Connected successfully"));
+    } catch (e: any) {
+      console.error("Test connection error:", e);
+      setTestMsg("G¥î " + (e?.message || "Request failed - check console"));
+    } finally {
+      setTesting(false);
+    }
+  };
...
+                    setTestMsg(`=ƒôª Uploaded: ${json.name} GåÆ ${json.path}`);
+                  } catch (err: any) {
+                    setTestMsg("G¥î " + (err?.message || "Upload failed"));
+                  }
+                }}
+              />
...
+          }}
+        >
+          {testing ? "TestingGÇª" : "Test connection"}
+        </button>
+        {testMsg && (
...
+}
+
+/* GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ Palette GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ */
+
...
+        {btn(() => onAdd("source"), "n+ï Add Source")}
+        {btn(() => onAdd("destination"), "n+ï Add Destination")}
+      </div>
+      <div style={{ fontSize: 12, color: "#6b7280", marginTop: 8 }}>
+        Drag, connect <b>Source GåÆ Destination</b>, select to configure on the right.
+      </div>
+    </div>
+  );
+}
+
+/* GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ Main editor (Zustand persistence) GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ */
+
